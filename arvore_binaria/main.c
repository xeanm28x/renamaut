...
int main(int argc, char *argv[])
{
    ...
    clock_t fim1 = clock();
    medir_tempo(ini1, fim1, "Importar RENAMAUT", "../tempos_execucao/arvore_binaria.log");

    clock_t ini2 = clock();
    importar_base(base_dados, &arvore);
    clock_t fim2 = clock();
    medir_tempo(ini2, fim2, "Importar Base ERMAUF", "../tempos_execucao/arvore_binaria.log");
    ...
    do
    {
        ...
        case SEARCH_OPTION:
            ...
            clock_t fim = clock();
            medir_tempo(ini, fim, "Busca RENAMAUT", "../tempos_execucao/arvore_binaria.log");
        ...
        case CHANGE_STATUS_OPTION:
            ...
            if (aux == NULL) {
                ...
                medir_tempo(ini_cs, fim_cs, "Inativação - Registro não encontrado", "../tempos_execucao/arvore_binaria.log");
                wait_enter("\nMáquina Autônoma não encontrada.");
            } else if (aux->status == 0) {
                clock_t fim_cs = clock();
                medir_tempo(ini_cs, fim_cs, "Inativação - Já inativa", "../tempos_execucao/arvore_binaria.log");
                ...
                if (confirmacao == 1) {
                    inativar(&arvore, aux);
                    medir_tempo(ini_cs, fim_cs, "Inativação realizada", "../tempos_execucao/arvore_binaria.log");
                    wait_enter("\n\nMáquina inativada com sucesso!");
                } else {
                    medir_tempo(ini_cs, fim_cs, "Inativação cancelada", "../tempos_execucao/arvore_binaria.log");
                    wait_enter("\n\nCancelando...");
                }
            }
            break;
        ...
        case RESPONSABILITY_REPORT_OPTION: {
            ...
            clock_t fim = clock();
            medir_tempo(ini, fim, "Relatório por Responsável", "../tempos_execucao/arvore_binaria.log");
        ...
        case CATEGORY_REPORT_OPTION: {
            ...
            clock_t fim = clock();
            medir_tempo(ini, fim, "Relatório por Categoria", "../tempos_execucao/arvore_binaria.log");
